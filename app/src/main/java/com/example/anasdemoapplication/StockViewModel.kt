...
constructor(
    ...
    private val _totalHoldings = MutableStateFlow<RequestResult<TotalHolding>?>(null)
    val totalHolding = _totalHoldings.asStateFlow()
        ...
        viewModelScope.launch {
            when (val result = stockRepository.getHoldingList()) {
                is RequestResult.Success -> {
                    _totalHoldings.update { RequestResult.Success(result.data) }
                }
